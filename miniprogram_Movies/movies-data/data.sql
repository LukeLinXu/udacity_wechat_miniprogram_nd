...
SET @IMAGE_BASE_URL = "https://udacity-miniprogram-nd-1257155712.cos.na-toronto.myqcloud.com/"; -- FOR EXAMPLE: https://*****.ap-shanghai.myqcloud.com/
...
ALTER TABLE `comments`
  ADD CONSTRAINT `commentsws_link` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`);
